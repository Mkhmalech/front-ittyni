...
import { SearchLink } from '../ui-ittyni/src/links/Links';
  ...
  return (
    <>
      <div style={{ display: "flex" }}>
        ...
        <SearchBox >
          <LabTestSearch showInMobile={showSearch}/>
        </SearchBox>
        <UserNav>
          {/* search link mobile */}
          <SearchLink onClick={(e: any) => setShowSearch(!showSearch)}>
      ...
      <div style={{ display: "flex" }}>
        <Route path="/:category/" component={NavTabs} />
      </div>
    </>
  );
};
