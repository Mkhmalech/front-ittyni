...
export const cabinetfetchByCity = (city: string) =>store.dispatch({
    ...
    path : 'cabinets',
    payload : {
        query:`query{listCabinetsTwntyByCity(city: "${city}"){_id account{name type}views contact{address{street city}tele{fix}}}}`
    }
})
export const cabinetfetchAllCity = (city: string) =>store.dispatch({
    ...
    path : 'cabinets',
    payload : {
        query:`query{listCabinetsAllByCity(city: "${city}"){_id account{name type}views contact{address{street city}tele{fix}}}}`
    }
})
export const cabinetfetchDetails = (id: string) =>store.dispatch({
    ...
    path : 'cabinets',
    payload : {
        query:`query{listCabinetDetailsById(id:"${id}"){_id account {name type}views contact{address{street city}tele{fix}}}}`
    }
})
