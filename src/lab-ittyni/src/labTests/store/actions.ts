export enum LabTestActions {
   ...
   * filter all lab test by english name
   */
  LAB_TESTS_DETAILS_BY_ID = "@@labtests/LAB_TESTS_DETAILS_BY_ID",
  LAB_TESTS_DETAILS_BY_ID_ERROR = "@@labtests/LAB_TESTS_DETAILS_BY_ID_ERROR",
  LAB_TESTS_DETAILS_BY_ID_SUCCESS = "@@labtests/LAB_TESTS_DETAILS_BY_ID_SUCCESS",
}

export enum CartActions {
  ADD_TEST_TO_CART = "@@cart/ADD_TEST_TO_CART",
  ADD_TEST_TO_CART_SUCCESS = "@@cart/ADD_TEST_TO_CART_SUCCESS",
  ADD_TEST_TO_CART_ERROR = "@@cart/ADD_TEST_TO_CART_ERROR",
}
